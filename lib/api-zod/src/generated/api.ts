...
export const AdminGetUserResponse = zod.object({
  ...
  frozenBalance: zod.string().optional(),
  ...
  createdAt: zod.number().optional(),
  lastActive: zod.number().optional(),
  buyerDeals: zod.number().optional(),
  sellerDeals: zod.number().optional(),
  recentTransactions: zod.array(zod.object({}).passthrough()).optional(),
});
 ...
 */
export const GetAdminRevenueChartQueryParams = zod.object({
...
export const AdminListReviewsResponse = zod.object({
  reviews: zod.array(
    zod.object({
      ...
      createdAt: zod.number().optional(),
      dealId: zod.string().optional(),
      reviewer: zod.object({}).passthrough().optional(),
      seller: zod.object({}).passthrough().optional(),
    }),
  ),
  total: zod.number(),
  page: zod.number().optional(),
