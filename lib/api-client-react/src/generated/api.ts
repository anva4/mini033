...
/**
 * @summary Get detailed user info (admin)
 */
...
export const adminSetUserRole = async (
  id: string,
  adminSetUserRoleBody: AdminSetUserRoleBody,
  options?: RequestInit,
): Promise<User> => {
  return customFetch<User>(getAdminSetUserRoleUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(adminSetUserRoleBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: BodyType<AdminSetUserRoleBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type AdminSetUserRoleMutationResult = NonNullable<
  Awaited<ReturnType<typeof adminSetUserRole>>
>;
export type AdminSetUserRoleMutationBody = BodyType<AdminSetUserRoleBody>;
...
export const adminAdjustBalance = async (
  id: string,
  adminBalanceAdjustBody: AdminBalanceAdjustBody,
  options?: RequestInit,
): Promise<User> => {
  return customFetch<User>(getAdminAdjustBalanceUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(adminBalanceAdjustBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: BodyType<AdminBalanceAdjustBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type AdminAdjustBalanceMutationResult = NonNullable<
  Awaited<ReturnType<typeof adminAdjustBalance>>
>;
export type AdminAdjustBalanceMutationBody = BodyType<AdminBalanceAdjustBody>;
...
/**
 * @summary Delete product permanently (admin)
 */
...
/**
 * @summary Daily revenue chart for admin
 */
export const getGetAdminRevenueChartUrl = (
  params?: GetAdminRevenueChartParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/admin/stats/revenue?${stringifiedParams}`
...
export const getAdminRevenueChart = async (
  ...
  return customFetch<RevenueChartPoint[]>(getGetAdminRevenueChartUrl(params), {
    ...options,
    method: "GET",
  });
};
...
export const getGetAdminRevenueChartQueryKey = (
  ...
  return [`/api/admin/stats/revenue`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetAdminRevenueChartQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getAdminRevenueChart>>
  > = ({ signal }) =>
    getAdminRevenueChart(params, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetAdminRevenueChartQueryOptions(params, options);
